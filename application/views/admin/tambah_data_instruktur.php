        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Data Instruktur</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambah Data Instruktur</h3>
        ...
        <?php if (isset($error)) {
          ...
          <div class="row">
              <div class="col-md-12">
                <?php echo form_open_multipart('admin/tambah_data_instruktur');?>
                    <div class="form-group">
                        <input type="text" name="nama" class="form-control" placeholder="Masukan Nama">
                        <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <input type="text" name="pengalaman" class="form-control" placeholder="Masukan Pengalaman">
